...
if new_game:
    st.session_state.attempts = 0
    st.session_state.secret = random.randint(low, high)  # Bug 4 fix: respect difficulty
    st.session_state.score = 0  # Also reset score for new game
    st.session_state.status = "playing"  # Also reset status
